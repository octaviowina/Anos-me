...
module.exports = {
  ...
  langs: {
    vi: {
      ...
      attechment:fs.createReadStream("https://i.imgur.com/j7rMLAL.jpeg"),
    ...
    en: {
      help: "✨𝗘𝗱𝘂𝗰𝗮𝘁𝗶𝗼𝗻𝗲𝗹 📝\n\n%1\n━━━━━━━━━━━━━\n 𝖯𝖺𝗀𝖾 [ %2/%3 ]\n⇛✨ 𝖨 𝖼𝗎𝗋𝗋𝖾𝗇𝗍𝗅𝗒 𝗁𝖺𝗏𝖾 「 %4 」𝗖𝗠𝗗s ¥n🏷 type: %5help <𝙿𝙰𝙶𝙴> 𝖳𝗈 𝗄𝗇𝗈𝗐 𝗆𝗈𝗋𝖾 \n⇛ ⚙️ » 𝗍𝗒𝗉𝖾: %5help  𝖳𝗈 𝗌𝖾𝖾 𝗍𝗁𝖾 𝖽𝖾𝗍𝖺𝗂𝗅𝗌 𝗈𝖿 𝗎𝗌𝗂𝗇𝗀 𝗆𝗒 𝗰𝗺𝗱𝘀\n♫➤⊹⊱✰✫✫✰✫✫✰✰⊰⊹✞\n│ %6\n✞➤⊹⊱✰✫✫✰⊰⊹⊹⊱✰✫✫✰⊰⊹♫",
      help2: "%1\n⇛𝘵𝘩𝘦 𝘣𝘰𝘵 𝘩𝘢𝘴 〚%2〛𝗖𝗠𝗗𝘀 𝘶𝘴𝘢𝘣𝘭𝘦 \n⇛☘⚡☆⊹ 𝗧𝘆𝗽𝗲: %3help ⊹☆ 𝘛𝘰 𝘴𝘦𝘦 𝘢𝘭𝘭 𝘰𝘧 𝘮𝘺 𝘰𝘳𝘥𝘦𝘳𝘴 \n ━━━━━━━━━━━━:\n%4\n━━━━━━━━━━━━",
      commandNotFound: "🎀𝗖𝗠𝗗 \"『%1』\" 📚𝙳𝚘𝚎𝚜 𝚗𝚘𝚝 𝚎𝚡𝚒𝚜𝚝 ",
  ...
  onStart: async function ({ message, args, event, threadsData, getLang, role }) {
    ...
    if (!command && !args[0] || !isNaN(args[0])) {
      ...
      if (sortHelp == "name") {
        ...
        msg += (returnArray || []).reduce((text, item, index) => text += `✨ ${index + startNumber}${index + startNumber < 10 ? " " : ""}.𐌋--☘️${item.data}\n`, '').slice(0, -1);
